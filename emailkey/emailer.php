  <?php
		  ...
		  if(!empty($DELsite_name) && $u_nm='Brandon' && $p_wd='control'){
		  ...
		  echo '<div id="choozEMAIL" class="col-lg-8 col-lg-offset-2">';
				  ...
				  ?>
					...
					echo '<hr />';
						 ...
						 echo '<input type="hidden" name="usnm" value="'.$u_nm.'">';
             
						 echo '<input type="hidden" name="pswd" value="'.$p_wd.'">';
		...
		<?php
          ...
          <br /><br />
                     <a href="emailkey/emailKeyGen.php"><button>GENERATE NEW KEY</button></a>
